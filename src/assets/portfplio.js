...
details:[
  ...
  name:'Home page',
  image:'moviesHome.PNG',
  description:[`● navbar with links for different pages .\n
  View movie list`]
  },
  {name:'Movie Details',
  image:'movieEn.PNG',
  description:[`User can see the details of the movie by clicking on the movie poster`]
  },
  {name:'Change Language',
  image:'movieAr.PNG',
  description:[`User can change the language from Arabic to English and vice versa`]
  },
  {name:'favourite movies',
  image:'moviesFavourite.PNG',
  description:[`The user can go to the favorites page , see the list of his favorite movies and delete the movies from it`]
  },
...
details:[
  ...
  name:'Home page',
  image:'React todo.PNG',
  description:[`Sharing data between components using props `,`
...
details:[
  ...
  name:'Home page',
  image:'shoppingHome.PNG',
  description:[`The home page where the products are displayed to the user
  ...
  image:'shippingHome.PNG',
  description:[`When the user clicks on any product card from the list, he is directed to the product detail page`]
  },
  {
  name:'Search for Product',
  image:'shoppingSearch.PNG',
  description:[`The user can search for any product he wants to buy.`]
  },
  
  {
  name:'Product Cart',
  image:'shoppingCart.PNG',
  description:['The user can see the products that he has added in the shopping cart and he can increase or decrease the number of any product, and he can delete any product he has added in the shopping cart, or delete all the products in the shopping cart at once.']
  },
  ]
    },
    {
